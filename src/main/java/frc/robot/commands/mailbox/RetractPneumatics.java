...
public class RetractPneumatics extends Command {

  private MailboxPneumatics mailboxPneumatics;

  /** Creates a new RetractPneumatics. */
  public RetractPneumatics() {
    mailboxPneumatics = RobotContainer.mailboxPneumatics;
